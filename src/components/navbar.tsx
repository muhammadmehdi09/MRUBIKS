        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
              <a href=""><li> <Image src={require("../../Images/Logo.png")} alt='Logo' width={100} height={100} className='block lg:hidden place-self-center' /></li></a>
          ...
          <a href='http://localhost:3000/'>
            <Image src={require("../..//Images/Logo.png")} alt='Logo' width={75} height={75}  className='hidden lg:block' />
          </a>
        </div>
